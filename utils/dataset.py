...
def load_dataset(dataset_name: str):
    ...
    heterophily_datasets = ["roman-empire"]  # ← 追加
    ...
    heterophily_map = {name.lower(): name for name in heterophily_datasets}
    ...
    elif dataset_name_lower in heterophily_map:
        canonical_name = heterophily_map[dataset_name_lower]
        dataset = HeterophilousGraphDataset(
            root="./data/Heterophilous",
            name=canonical_name,
            transform=T.NormalizeFeatures(),
        )
